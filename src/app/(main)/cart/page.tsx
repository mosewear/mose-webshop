      ...
      <div className="min-h-screen pt-24 md:pt-32 px-4 pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-16 md:py-24">
            ...
            <h1 className="text-4xl md:text-6xl font-display mb-4 uppercase">LEEG</h1>
            <p className="text-gray-600 mb-8 max-w-md mx-auto text-lg">
              Je winkelwagen is leeg. Ontdek onze collectie.
            </p>
            <Link
              href="/shop"
    ...
    <div className="min-h-screen pt-24 md:pt-32 px-4 pb-32 md:pb-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-12 md:mb-16">
          <div>
            <h1 className="text-5xl md:text-7xl font-display uppercase mb-2">WINKELWAGEN</h1>
          ...
          <button
            ...
            aria-label="Leeg winkelwagen"
          >
            <Trash2 size={20} className="group-hover:scale-110 transition-transform" />
            <span className="hidden md:inline text-sm uppercase tracking-wider font-semibold">Leeg wagen</span>
          </button>
        </div>
        ...
        <div className="hidden md:block bg-gray-50 px-8 md:px-12 py-8 md:py-10 mt-0">
          <div className="max-w-2xl ml-auto space-y-6">
            ...
            <div className="flex justify-between items-baseline">
              <span className="font-display text-2xl uppercase">Totaal</span>
          ...
          <div className="md:hidden fixed inset-0 bg-black/50 z-50 flex items-end animate-fadeIn">
            <div className="bg-white w-full rounded-t-2xl p-6 pb-8 animate-slideUp max-h-[80vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-display text-2xl uppercase">Samenvatting</h3>
                <button
              ...
              <div className="space-y-4">
                ...
                <div className="border-t-2 border-black pt-4">
                  <div className="flex justify-between items-baseline mb-2">
                    <span className="font-display text-xl uppercase">Totaal</span>
      ...
      {showClearConfirm && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white border-4 border-black p-8 max-w-md w-full">
            <h3 className="font-display text-3xl mb-4 uppercase">Winkelwagen legen?</h3>
