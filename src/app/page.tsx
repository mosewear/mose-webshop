          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8 text-xs md:text-sm text-gray-600">
            ...
            <div className="flex items-center gap-2">
              <svg className="w-8 h-5" viewBox="0 0 38 24" fill="none">
                <rect width="38" height="24" rx="3" fill="#5A1BB1"/>
                <path d="M14 12L11 8H9L12 12L9 16H11L14 12Z" fill="white"/>
                <path d="M19 8L16 12L19 16H21L24 12L21 8H19Z" fill="white"/>
                <path d="M24 8L27 12L24 16H26L29 12L26 8H24Z" fill="white"/>
              </svg>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">14 dagen retourrecht</span>
            </div>
