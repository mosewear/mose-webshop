...
const nl: EmailTranslationKeys = {
  ...
  insiderCommunity: {
    ...
    ps: 'P.S. Nog {{days}} dagen tot lancering. Je kunt nu al in de presale met 30% korting bestellen op www.mosewear.com. Wees er snel bij, want op = op!',
  },
  insiderBehindScenes: {
...
const en: EmailTranslationKeys = {
  ...
  insiderCommunity: {
    ...
    socialInsta: 'Instagram: @mosewearcom',
    socialFb: 'Facebook: @mosewearcom',
    closing: 'We\'re building this together. This isn\'t just clothing. This is a statement. A choice for quality over quantity. For local over global. For real over fake. See you at launch!',
    ps: 'P.S. {{days}} days until launch. You can now order in presale with 30% discount on www.mosewear.com. Be quick, because when it\'s gone, it\'s gone!',
  },
  insiderBehindScenes: {
