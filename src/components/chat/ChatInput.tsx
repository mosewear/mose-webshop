    ...
    <div className="flex-shrink-0 border-t-4 border-black p-4 bg-white">
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-6 py-3 bg-brand-primary border-2 border-black hover:bg-brand-primary-hover disabled:bg-gray-200 disabled:cursor-not-allowed transition-colors flex items-center gap-2 font-display uppercase text-sm tracking-wide"
