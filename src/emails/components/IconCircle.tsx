...
const iconSvgMap: Record<IconType, string> = {
  ...
  'truck': 'M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2m9.5 0a2.5 2.5 0 1 0 5 0 2.5 2.5 0 1 0-5 0Zm-11 0a2.5 2.5 0 1 0 5 0 2.5 2.5 0 1 0-5 0ZM16 6h4l4 4v4h-4',
