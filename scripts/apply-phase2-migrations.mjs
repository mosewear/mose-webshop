#!/usr/bin/env node
/**
 * Phase 2 migration applier (mirror of apply-phase0-migrations.mjs).
 *
 * Usage:
 *   SUPABASE_ACCESS_TOKEN=sbp_... node scripts/apply-phase2-migrations.mjs
 */
...
const PHASE2_VERSIONS = ['20260520111000']
...
async function main() {
  for (const v of PHASE2_VERSIONS) {
  ...
  console.log('[phase2-migrations] done')
}
