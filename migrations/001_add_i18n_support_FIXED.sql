-- =====================================================
-- MOSE I18N Database Migration - COMPLETE VERSION
-- Adds multi-language support to ALL tables
-- =====================================================
...
-- 3. Add English columns to PAGES table (if it exists)
ALTER TABLE pages
ADD COLUMN IF NOT EXISTS title_en TEXT,
ADD COLUMN IF NOT EXISTS content_en TEXT;

-- 4. Add English columns to HOMEPAGE_SETTINGS table
...
-- 5. Add default English translations to homepage_settings
